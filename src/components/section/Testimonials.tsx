...
const sideTestimonials = [
  {
    quote:
      "Fast, thoughtful, and deeply collaborative. Alture felt like part of our team from day one.",
    name: "Naomi Voss",
...
export default function Testimonials() {
  return (
    <section className="w-full bg-[#F5F5F5] px-4 py-12 sm:px-5 md:px-10 lg:px-16 lg:py-20">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:w-[75%] lg:grid-cols-[0.8fr_0.95fr_0.95fr] lg:items-stretch lg:min-h-130">
        ...
        >
          ...
          <div className="absolute bottom-0 z-10 p-5 text-white md:p-6">
            ...
            <p className="max-w-75 text-[16px] font-medium leading-[1.2] tracking-tight md:max-w-85 md:text-[18px]">
              “Working with Alture felt less like hiring a design agency and more like gaining a strategic partner forever.”
            </p>
