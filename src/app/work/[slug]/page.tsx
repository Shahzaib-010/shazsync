...
export default async function CaseStudyPage({ params }: Props) {
  ...
  return (
    <main className="bg-white">
      ...
      {/* ── Header ── */}
      <div className="mx-auto w-[90%] sm:w-[90%] sm:w-[95%] pt-28 md:pt-32">
      ...
      <div className="mx-auto mt-8 w-[90%] sm:w-[95%]">
      ...
      {/* ── Brief para ── */}
      <div className="mx-auto w-[90%] sm:w-[90%] sm:w-[95%] pt-10 md:pt-12">
      ...
      <div className="mx-auto w-[90%] sm:w-[90%] sm:w-[95%] pb-16 pt-10 md:pb-20 md:pt-12">
      ...
      {outcomeSection && (
        <div className="border-t border-neutral-100">
          <div className="mx-auto w-[90%] sm:w-[90%] sm:w-[95%] py-16 md:py-24">
      ...
      <div className="border-t border-neutral-100 bg-[#f8f8f8]">
        <div className="mx-auto w-[90%] sm:w-[90%] sm:w-[95%] py-16 md:py-20">
